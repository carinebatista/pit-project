                ...
                {editingTodo === todo._id ? (
                  <div className="flex items-center gap-x-3"> 
                    ...
                    <div className="flex gap-x-2">
                      <button 
                        onClick={() => saveEdited(todo._id)}
                        className="px-4 py-2 bg-green-400 text-white rounded-lg hover:bg-green-600
                        cursor-pointer" >
                        <MdOutlineDone/>
                      </button>
                      <button
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-x-4 overflow-hidden">
                        <button 
                          ...
                          className={`flex-shrink-0 h-6 w-6 border rounded-full flex 
                      ...
                      <div className="flex gap-x-2">
                        <button
                          className="p-2 text-blue-400 hover:text-blue-700 rounded-lg 
                          hover:bg-blue-50 duration-200 cursor-pointer"
                          onClick={() => startEditing(todo)}> <MdModeEditOutline/></button>
                        <button
                          onClick={() => deleteTodo(todo._id)}
                          className="p-2 text-red-500 hover:text-red-700 rounded-lg 
                          hover:bg-red-50 duration-200 cursor-pointer"
                        >
                          <FaTrash/>
                        </button>
                      </div>
